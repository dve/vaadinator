...
public class MappingProcessor extends AbstractProcessor {
	...
	private void processDisplayBeanElements(Set<TypeElement> displayBeanElements) {
		...
		for (TypeElement annotation : annotations) {
			...
			try {
				...
				for (Element mapperElement : annotatedMappers) {
					...
					if (mapperTypeElement != null && DisplayBeanPrism.getInstanceOn(mapperTypeElement) != null) {
